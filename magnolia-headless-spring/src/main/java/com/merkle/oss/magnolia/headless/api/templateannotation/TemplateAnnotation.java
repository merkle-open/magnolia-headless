...
public class TemplateAnnotation {
    ...
    @GetMapping(value = "/templateAnnotations.json", produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<Map<String, String>> templateAnnotations(
        ...
        try {
            ...
            return ResponseEntity.ok(getTemplateAnnotations(node));
        } catch (Exception e) {
